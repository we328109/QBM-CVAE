...
class MLP_REG(nn.Module):
    def __init__(
        ...
        self.l1 = nn.Linear(ft_dim, 256) #self.l1 = nn.Linear(ft_dim, 512)
        self.l2 = nn.Linear(256, 512) #self.l2 = nn.Linear(512, 256)
        self.l3 = nn.Linear(512, 256) #self.l3 = nn.Linear(256, 256)
